...
public class TestDataImporter {
    ...
    public void importData(SessionFactory sessionFactory) {
        try (var session = sessionFactory.openSession()) {
            ...
            var moscowPlazaRoom_1 = saveRoom(session, moscowPlaza, 1, RoomType.TRPL, 25.5, 3, BigDecimal.valueOf(1500), true, 1, "Nice room in moscowPlaza!");
            var moscowPlazaRoom_2 = saveRoom(session, moscowPlaza, 2, RoomType.QDPL, 45.0, 4, BigDecimal.valueOf(2500), true, 1, "Nice room in moscowPlaza");
            var moscowPlazaRoom_7 = saveRoom(session, moscowPlaza, 7, RoomType.TWIN, 35.5, 2, BigDecimal.valueOf(1900.85), true, 3, "Nice room in moscowPlaza!");
            var moscowPlazaRoom_10 = saveRoom(session, moscowPlaza, 10, RoomType.SGL, 20.5, 1, BigDecimal.valueOf(850.58), false, 5, "Nice room in moscowPlaza!");
            var kievPlazaRoom_3 = saveRoom(session, kievPlaza, 3, RoomType.TRPL, 55.5, 3, BigDecimal.valueOf(1700), true, 1, "Nice room in kievPlaza!");
            var kievPlazaRoom_4 = saveRoom(session, kievPlaza, 4, RoomType.QDPL, 15.0, 4, BigDecimal.valueOf(2900), true, 1, "Nice room in kievPlaza!");
            var kievPlazaRoom_6 = saveRoom(session, kievPlaza, 6, RoomType.TWIN, 35.5, 2, BigDecimal.valueOf(1950.85), true, 3, "Nice room in kievPlaza!");
            var kievPlazaRoom_12 = saveRoom(session, kievPlaza, 12, RoomType.SGL, 23.5, 1, BigDecimal.valueOf(950.58), false, 5, "Nice room in kievPlaza!");
            var piterPlazaRoom_3 = saveRoom(session, piterPlaza, 3, RoomType.TRPL, 25.5, 3, BigDecimal.valueOf(1500), true, 1, "Nice room in piterPlaza!");
            var piterPlazaRoom_1 = saveRoom(session, piterPlaza, 1, RoomType.QDPL, 45.0, 4, BigDecimal.valueOf(2500), true, 1, "Nice room in piterPlaza!");
            var piterPlazaRoom_6 = saveRoom(session, piterPlaza, 6, RoomType.TWIN, 35.5, 2, BigDecimal.valueOf(1900.85), true, 3, "Nice room in piterPlaza!");
            var piterPlazaRoom_5 = saveRoom(session, piterPlaza, 5, RoomType.SGL, 20.5, 1, BigDecimal.valueOf(850.58), false, 5, "Nice room in piterPlaza!");
            var minskPlazaRoom_1 = saveRoom(session, minskPlaza, 1, RoomType.TRPL, 25.5, 3, BigDecimal.valueOf(1900), true, 1, "Nice room in minskPlaza!");
            var minskPlazaRoom_2 = saveRoom(session, minskPlaza, 2, RoomType.QDPL, 45.0, 4, BigDecimal.valueOf(2100), true, 1, "Nice room in minskPlaza!");
            var minskPlazaRoom_7 = saveRoom(session, minskPlaza, 7, RoomType.TWIN, 35.5, 2, BigDecimal.valueOf(1100.85), true, 3, "Nice room in minskPlaza!");
            var minskPlazaRoom_10 = saveRoom(session, minskPlaza, 10, RoomType.SGL, 20.5, 1, BigDecimal.valueOf(1850.58), false, 5, "Nice room in minskPlaza!");

            saveBookingRequest(session, LocalDateTime.now(), moscowPlaza, moscowPlazaRoom_1, natalya, of(2022, Month.OCTOBER, 10), of(2022, Month.OCTOBER, 15), Status.NEW);
            saveBookingRequest(session, LocalDateTime.now(), moscowPlaza, moscowPlazaRoom_7, natalya, of(2022, Month.NOVEMBER, 10), of(2022, Month.NOVEMBER, 15), Status.NEW);
            saveBookingRequest(session, LocalDateTime.now(), kievPlaza, kievPlazaRoom_3, natalya, of(2022, Month.OCTOBER, 22), of(2022, Month.OCTOBER, 30), Status.APPROVED);
            saveBookingRequest(session, LocalDateTime.now(), piterPlaza, piterPlazaRoom_1, natalya, of(2022, Month.DECEMBER, 10), of(2022, Month.DECEMBER, 15), Status.APPROVED);
            saveBookingRequest(session, LocalDateTime.now(), minskPlaza, minskPlazaRoom_10, natalya, of(2023, Month.JANUARY, 10), of(2023, Month.JANUARY, 15), Status.PAID);
            saveBookingRequest(session, LocalDateTime.now(), kievPlaza, kievPlazaRoom_4, michail, of(2022, Month.OCTOBER, 10), of(2022, Month.OCTOBER, 15), Status.CANCELED);
            saveBookingRequest(session, LocalDateTime.now(), piterPlaza, piterPlazaRoom_6, michail, of(2022, Month.DECEMBER, 10), of(2022, Month.DECEMBER, 15), Status.APPROVED);
            saveBookingRequest(session, LocalDateTime.now(), minskPlaza, minskPlazaRoom_2, michail, of(2023, Month.JANUARY, 10), of(2023, Month.JANUARY, 15), Status.PAID);
            saveBookingRequest(session, LocalDateTime.now(), kievPlaza, kievPlazaRoom_12, michail, of(2022, Month.OCTOBER, 10), of(2022, Month.OCTOBER, 15), Status.CANCELED);

            var minskPlazaReview_1 = saveReview(session, minskPlaza, natalya, LocalDateTime.of(2022, Month.OCTOBER, 9, 15, 25), Rating.FOUR);
            var minskPlazaReview_2 = saveReview(session, minskPlaza, michail, LocalDateTime.of(2022, Month.SEPTEMBER, 10, 15, 25), Rating.THREE);
            var minskPlazaReview_3 = saveReview(session, minskPlaza, michail, LocalDateTime.of(2022, Month.AUGUST, 18, 15, 25), Rating.THREE);
            var minskPlazaReview_4 = saveReview(session, minskPlaza, natalya, LocalDateTime.of(2021, Month.OCTOBER, 9, 15, 25), Rating.TWO);
    ...
    private Room saveRoom(Session session, Hotel hotel, Integer roomNo, RoomType type, Double square,
                          Integer bedCount, BigDecimal cost, boolean available, Integer floor, String description) {
    ...
    private Review saveReview(Session session, Hotel hotel, User user, LocalDateTime createdAt, Rating rating) {
