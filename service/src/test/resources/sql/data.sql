INSERT INTO users(id, role, email, password, firstname, lastname, birth_date, phone, photo_link, status, registered_at)
...
VALUES (1, (SELECT id FROM users WHERE email = 'FirstOwner@gmail.com'), 'MoscowPlaza', TRUE, 'APPROVED'),
       (2, (SELECT id FROM users WHERE email = 'FirstOwner@gmail.com'), 'MoscowHotel', TRUE, 'APPROVED'),
       (3, (SELECT id FROM users WHERE email = 'FirstOwner@gmail.com'), 'KievPlaza', TRUE, 'APPROVED'),
       (4, (SELECT id FROM users WHERE email = 'SecondOwner@gmail.com'), 'PiterPlaza', TRUE, 'NEW'),
       (5, (SELECT id FROM users WHERE email = 'SecondOwner@gmail.com'), 'MinskPlaza', TRUE, 'APPROVED');
...
VALUES (1, (SELECT id FROM hotel WHERE name = 'MinskPlaza'), 2, NOW(), 5),
       (2, (SELECT id FROM hotel WHERE name = 'MinskPlaza'), 3, NOW(), 3),
       (3, (SELECT id FROM hotel WHERE name = 'MinskPlaza'), 3, NOW(), 4),
       (4, (SELECT id FROM hotel WHERE name = 'MinskPlaza'), 2, NOW(), 2);
